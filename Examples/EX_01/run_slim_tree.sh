...
cd /work/dk_lab/work/afarinesh/SLiM_Tree_paper_EMB/EX_2


python3 /home/afarinesh.panahy/software/slim-tree tree table_stationary_distributions.csv -hpc -t 04:00:00 -p apophis -v 0.0015 
